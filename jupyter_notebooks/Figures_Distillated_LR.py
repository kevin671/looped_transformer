...
if __name__ == "__main__":
    ...
    model_list = [
        ...
        # },
        # {
        #    "name": "Looped_Transformer_b{16}_teacher_b32_progressive",
        #    "result_dir": "/work/gg45/g45004/looped_transformer/results2/linear_regression_loop",
        #    "run_id": "0610131812-Distillate_LR_loop_L1_ends{16}-2ecd",
        # },
        {
            "name": "Looped_Transformer_b{8}_teacher_b32_progressive",
            "result_dir": "/work/gg45/g45004/looped_transformer/results2/linear_regression_loop",
            "run_id": "0610173845-Distillate_LR_loop_L1_ends{8}-4b8e",
        },
        {
            "name": "Looped_Transformer_b{4}_teacher_b32_progressive",
            "result_dir": "/work/gg45/g45004/looped_transformer/results2/linear_regression_loop",
        ...
        # {
        #    "name": "Looped_Transformer_b{4}_teacher_b32",
        #    "result_dir": '/work/gg45/g45004/looped_transformer/results2/linear_regression_loop',
    ...
    for model_dict in model_list:
        ...
        b = int(model_dict["name"].split("{")[-1].split("}")[0])
        print(b)
        print(model_dict["name"])
        err, loop_err = eval_looped_model(model, xs, ys, loop_max=b)
        result_errs[model_dict["name"]] = err
    ...
    plt.savefig(
        "/work/gg45/g45004/looped_transformer/result_folder/Figures/Distill_LR_err_ui.png",
        dpi=600,
        bbox_inches="tight",
    )
