...
if __name__ == "__main__":
    ...
    for idx, model_name in enumerate(result_name_list):
        ...
        # err_std = err.std(0)
        ax.plot(err_mean, color=colors[idx], lw=fig_hparam['linewidth'], label=model_name.capitalize())
    ...
    plt.savefig("/work/gg45/g45004/looped_transformer/result_folder/Figures/Distill_LR_loop_err.png", dpi=600, bbox_inches='tight')
